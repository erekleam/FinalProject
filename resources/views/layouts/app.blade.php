            ...
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <a href="/cms/dashboard">
                                    ...
                                    <img src="/img/logo-2.png" width="80" alt="">
                                </a>
                            </div>

                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="/cms/dashboard" :active="request()->is('cms/dashboard')">
                                    {{ __('Dashboard') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/cms/books" :active="request()->is('cms/books')">
                                    {{ __('books') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/cms/authors" :active="request()->is('cms/authors')">
                                    {{ __('authors') }}
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/cms/libraries" :active="request()->is('cms/libraries')">
                                    {{ __('libraries') }}
                                </x-jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <x-jet-responsive-nav-link href="/cms/dashboard" :active="request()->routeIs('cms/dashboard')">
                            {{ __('Dashboard') }}
                        </x-jet-responsive-nav-link>
                        <x-jet-responsive-nav-link href="/cms/books" :active="request()->is('cms/books')">
                            {{ __('წიგნები') }}
                        </x-jet-responsive-nav-link>
                    </div>
